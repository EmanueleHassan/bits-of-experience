...
[[#ms_thesis][Master of Statistics - Thesis]]
...
** Master of Statistics - Thesis
  ...
  :END:
   ...
   This was a quite technical thesis. I enjoyed to work on it and I
   must say that I reached a good level. Cause doing that part-time in
   collaboration with IBM Research without even struggling that much
   was impressive. Also the final mark was good; so satisfied this
   time around.

   I think it is a little bit difficult to read for a person that does
   not know the literature of the topic... but I guess that is the
   life of academia. It becomes so technical that at some point just a
   bunch of people that make a big commitment to a very restricted
   research field can and do get what is going on. It becomes too
   narrow the focus for me at some point.
 ...
 #+begin_export html
 <object data="../../pdfs/Hassan_Thesis_Bayes_Net.pdf" type="application/pdf"
   ...
   <iframe   jsname="L5Fo6c" jscontroller="usmiIb"
	     ...
	     frameborder="0" allowfullscreen="" src="../../pdfs/Hassan_Thesis_Bayes_Net.pdf"
	     width="100%" height="600px" align="center"/>
