...
- *IBM*    /Junior Software Engineer Sep 2019 -/
  ...
  ◦ Exposing myself to continous education that lets me appreciate key architectural ideas such as serverless infrastructure, microservices, virtualization, IaaS, PaaS, SaaS, DLT, data warehouses, data clusters, data lakes, quantum computing idea and limits.

  ◦ Speaker at Pydata Zurich - An introduction to Image Recognition and CNN leveraging transfer learning and Data Augmentation.

  ◦ IBM Blockchain Advocate - Presenter at IBM Studio Meetup.
