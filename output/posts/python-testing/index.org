...
twine upload -r <Feed Specified in $HOME/pypirc> dist/*
   ...
   some workarounds such as [[https://stackoverflow.com/questions/21064581/how-to-overwrite-pypi-package-when-doing-upload-from-command-line][this]], this is not generally
...
* TODO continue from here
  ...
  You can continue and enhance your understanding of testing with
  python by working with the [[https://www.obeythetestinggoat.com/book/chapter_03_unit_test_first_view.html][following resource]].
