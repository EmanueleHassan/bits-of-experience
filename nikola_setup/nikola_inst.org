...
EDITOR = "/usr/bin/emacs25" # or whatever version or editor.
 ...
 $ echo $EDITOR
   ...
   *Side note*: the above is just important if you work with the =-e=
   (editor) flag when creating your posts. Otherwise you can safely
   ignore this without too many issues.
