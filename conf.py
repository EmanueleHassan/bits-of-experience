...
BLOG_AUTHOR = "Marco Hassan"  # (translatable)
...
BLOG_EMAIL = "marco.hassan30@gmail.com"
BLOG_DESCRIPTION = "A readable view on my studying adventures."  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('/pages/foto-blog/', 'Foto Blog', 'fa fa-camera-retro'),
...
PAGES = PAGES + (("pages/*.tex", "pages", "page.tmpl"),)
