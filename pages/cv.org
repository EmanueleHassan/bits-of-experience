...
- *IBM*    /Junior Software Engineer Sep 2019 -/
  ...
  ◦ Worked on a 4 month NLP PoC for a client in the public
    ...
    sever. Understood that in real world projects the focus is much
    more about getting the right information architecture than to use
    the most elegant and theoretical compelling ML model. 

    Understood the importance of facing clients in an appropriate way. Lots
    of progress still to be done in the area.
