...
Alone, pure math won't work; it has to be enriched by sound engineering best practices.
I grow up the belief that such practices make the difference in the real and the data world and decided at first to enrich my knowledge in these.

<br>
<br>

Just with a solid basis on such practices it is possible to apply sophisticated math models in a meaningful way by creating winning solutions and ecosystems.
