...
- [[*peek references][peek references]]
- [[*Refactor][Refactor]]
- [[*Flycheck][Flycheck]]
- [[*lsp format buffer][lsp format buffer]]
- [[*Projectile][Projectile]]
- [[*class hierarchy][class hierarchy]]
- [[*lsp-header-breadcrumb][lsp-header-breadcrumb]]
- [[*Project Root][Project Root]]
- [[*On checking the hierarchy and dependencies][On checking the hierarchy and dependencies]]
- [[*treemacs][treemacs]]
- [[*Troubleshooting][Troubleshooting]]
- [[*Building and Testing][Building and Testing]]
- [[*Debugging][Debugging]]
- [[*Auto-completion][Auto-completion]]
- [[*Lsp java deps list][Lsp java deps list]]
- [[*Organize Imports][Organize Imports]]  
- [[*Note that it will take me some time to completely migrate to Emacs for Java development][Note that it will take me some time to completely migrate to Emacs for Java development]]
- [[*ISSUES][ISSUES]]
