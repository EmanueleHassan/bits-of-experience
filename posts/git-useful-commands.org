...
** On renaming commits
   ...
   Then you can do it with the =rebase= property.

   You can then rename the different commits according to the
   following schema:
   
   #+begin_export html
    <img src="../../images/Screenshot 2022-09-19 115422.png" class="center">
   #+end_export
...
** Renaming Commits Messages
   ...
   The idea in this case is to go on the relevant commit, press =r=
   and then select the reword option =w=.
