...
* Putting it all together
  ...
  There is the following flowchart which well summarize the general
  conceptual framework of SST. You understand it quite well now at
  high level:
  
  #+begin_export html
   <img src="../../images/Screenshot 2022-04-08 091844.png" class="center">
  #+end_export

  So you see that what you do is delta F. You also add the scenarios
  to it - the one for the market risk.

  Then you pass the results to Group Risk management where all of the
  other risks are processed and finally aggregated into the SST
  report. 
