...
<video controls="controls" width="600" height="400" 
       src="https://github.com/MarcoHassan/bits-of-experience/tree/gh-pages/videos/Bildschirmvideo%20aufnehmen%202020-04-16%20um%2015.16.33.mov"></video>
#+END_EXPORT
...
#+BEGIN_EXPORT html
<video controls="controls" width="600" height="400" 
       src="https://github.com/MarcoHassan/bits-of-experience/tree/gh-pages/videos/Bildschirmvideo%20aufnehmen%202020-04-16%20um%2015.25.53.mov"></video>
#+END_EXPORT
...
** Creating Intents
 ...
 #+BEGIN_EXPORT html
 <video controls="controls" width="600" height="400" 
   src="https://github.com/MarcoHassan/bits-of-experience/tree/gh-pages/videos/Bildschirmvideo%20aufnehmen%202020-02-20%20um%2011.19.26.mov"></video>
 #+END_EXPORT
...
** Create a Dialog with Child Nodes
 ...
 #+BEGIN_EXPORT html
 <video controls="controls" width="600" height="400" 
   src="https://github.com/MarcoHassan/bits-of-experience/tree/gh-pages/videos/Bildschirmvideo%20aufnehmen%202020-02-20%20um%2012.52.17.mov"></video>
 #+END_EXPORT
...
#+begin_export html
<img src="https://github.com/MarcoHassan/bits-of-experience/tree/gh-pages/images/Bildschirmfoto 2020-04-16 um 12.00.11.png" alt="Architecture" class="center">
#+end_export
...
understand its strength at best.
 ...
 #+BEGIN_EXPORT html
 <video controls="controls" width="600" height="400" 
   src="https://github.com/MarcoHassan/bits-of-experience/tree/gh-pages/videos/Bildschirmvideo%20aufnehmen%202020-04-16%20um%2014.31.49.mov"></video>
 #+END_EXPORT
