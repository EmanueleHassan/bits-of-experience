...
** Factory Methods
   ...
   You can then structure your code around the *general Logistics
   Object* and not the particular Objects.

   The general structure would then be as follows.

   #+begin_export html
    <img src="../../images/Screenshot 2022-11-09 122716.png" class="center">
   #+end_export
