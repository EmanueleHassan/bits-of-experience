...
** Mapping securities to cash flows

   You can read [[https://www.msci.com/documents/10199/5915b101-4206-4ba0-aee2-3449d5c7e95a][chapter 6 on these notes]].

   You see for instance there the general logic of converting all of
   the different types of instruments in cash flows.

   This exercise is also happening on our side. For lots of
   instruments the marking to market is trivial. For others it is a
   little bit more difficult. I mean at the end it is quite trivial
   decomposing but still the decomposition is necessary.

   
** Mapping cash flows on RiskMetrics vertices
